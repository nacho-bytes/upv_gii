...
public class ABB<E extends Comparable<E>> {
    ...
    public E predecesor(E e) {
      NodoABB<E> pred = predecesor(e, this.raiz, null);
      return pred == null ? null : pred.dato;
    }
     ...
     * @param e         Elemento cuyo predecesor se va a buscar
     * @param actual    Nodo actual en la busqueda
     * @param ascenIzq  Nodo ascendiente por la izquierda
     * @return  Predecesor de "e" en el nodo actual, o null si no existe
     */
    protected NodoABB<E> predecesor(E e, NodoABB<E> actual, NodoABB<E> ascenIzq) {
      if (actual == null) return null;
      int resC = actual.dato.compareTo(e);
      if (resC == 0) {
        if (actual.izq != null) return recuperarMax(actual.izq);
        else return ascenIzq;
      } else if (resC < 0) return predecesor(e, actual.der, actual);
      else return predecesor(e, actual.izq, ascenIzq);
    }
    ...
    /**  SII !esVacio(): devuelve el elemento maximo del ABB
    ...
    /** Devuelve el elemento maximo a partir del nodo actual 
     * @param    actual  Nodo actual en la busqueda
     * @return   Nodo que contiene el elemento maximo 
     */
    protected NodoABB<E> recuperarMax(NodoABB<E> actual) {
        if (actual.der == null) { 
            return actual;
        } else { return recuperarMax(actual.der); }
    }
