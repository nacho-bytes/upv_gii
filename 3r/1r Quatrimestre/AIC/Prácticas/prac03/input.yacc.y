...
r_inicio : LABEL
{
    switch (modo) {
        ...
        case m_datos:
 	    if (pending_label) {
            	te_inserta(etiqueta, pos_datos, m_datos);
            	pending_label=0;
            }	
        	pending_label =1;
...
| DE_ASCIIZ T_STRING
{
    ...
    for (i = 0; i <= (strlen($2) + 1); i++) // Sumo 1 por el null terminated
    {
        ...
        escribe_mem_datos(pos_datos + i, valor, t_char, NO);
...
T_INT_LIT
{
    switch (tipo) {
        case t_byte:
            ...
            valor.int_b = (byte) $1;
            escribe_mem_datos(pos_datos, valor, t_byte, NO);
        ...
        case t_half:
            ...
            valor.int_h = (half) $1;
            escribe_mem_datos(pos_datos, valor, t_half, NO);
        ...
        case t_word:
            ...
            valor.int_w = (word) $1;
            escribe_mem_datos(pos_datos, valor, t_word, NO);
        ...
        case t_dword:
            ...
            valor.int_d = (dword) $1;
            escribe_mem_datos(pos_datos, valor, t_dword, NO);
...
T_FP_LIT
{
    switch (tipo) {
        case t_float:
            ...
            valor.fp_s = (float) $1;
            escribe_mem_datos(pos_datos, valor, t_float, NO);
        ...
        case t_double:
            ...
            valor.fp_d = (double) $1;
            escribe_mem_datos(pos_datos, valor, t_double, NO);
...
| T_INT_LIT
{
    switch (tipo) {
        case t_float:
            ...
            //mem_etiqueta(pos_datos, tipo, NO);
            pos_datos += sizeof (float);
            break;
        case t_double:
            if (!esta_alineada_dir_double(pos_datos))
...
T_INT_LIT
{
    ...
    escribe_int_reg(idx_ireg, (dword) $1, t_dword, NO);
...
(
    ...
    Rint[28].valor = SegDatos.inicio;
    SegDatos.final = pos_datos;
    SegInstruc.inicio = 0; /* Segmento de instrucciones */
    // Añadimos una instruccion ficticia por que se cuela tras la trap
    SegInstruc.final = pos_instruc+4; 
