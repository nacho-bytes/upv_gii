...
%type <ivalue> r_inmediato_lo r_inmediato_hi r_inmediato_disp r_posicion
...
| DE_ASCIIZ T_STRING
{
    ...
    for (i = 0; i <= (strlen($2) + 1); i++) // Sumo 1 por el null terminated
    {
        ...
        mem_escribe_region_datos(mm, region, pos[region] + i, valor, t_byte);
    }
...
T_INT_LIT
{
    switch (tipo) {
        case t_byte:
            ...
            valor.int_d = (byte) $1;
            mem_escribe_region_datos(mm, region, pos[region], valor, t_byte);
        ...
        case t_half:
            ...
            valor.int_d = (half) $1;
            mem_escribe_region_datos(mm, region, pos[region], valor, t_half);
        ...
        case t_word:
            ...
            valor.int_d = (word) $1;
            mem_escribe_region_datos(mm, region, pos[region], valor, t_word);
        ...
        case t_dword:
            ...
            valor.int_d = (dword) $1;
            mem_escribe_region_datos(mm, region, pos[region], valor, t_dword);
...
T_FP_LIT
{
    switch (tipo) {
        case t_float:
            ...
            valor.fp_s = (float) $1;
            mem_escribe_region_datos(mm, region, pos[region], valor, t_float);
        ...
        case t_double:
            ...
            valor.fp_d = (double) $1;
            mem_escribe_region_datos(mm, region, pos[region], valor, t_double);
