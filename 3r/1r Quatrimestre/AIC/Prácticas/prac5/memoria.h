...
#define ALIGN_REGION PAGE_SIZE /* Las regiones se alinean al tamaño de página */
...
#define lee_mem_datos(mm, dir, tipo) _lee_mem_datos(mm, dir, tipo, __FILE__, __LINE__)
