...
set output "pca+gaussian-exp-ks.jpeg"
...
set label "Dimensionalidad" at 450,4.2 right
set label "Error (%)" at 1.3, 70 left
set label "MNIST PCA+Gaussian" at 50, 30 center font "HelveticaBold,30"
...
set key outside
plot for [col=2:14] "pca+gaussian-exp-ks.out" u 1:col t columnheader w lp lw 2
