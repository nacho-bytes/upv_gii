...
(define (problem original) 
  ...
  (:init
    ...
    (= (distancia-recorrida pass1) 0)
    (= (distancia-recorrida pass2) 0)
    (= (distancia-recorrida pass3) 0)
    (= (distancia-recorrida pass4) 0)
    (= (distancia-recorrida pass5) 0)
    (= (distancia-recorrida pass6) 0)
    (= (distancia-recorrida pass7) 0)
  ...
  (:goal (and
      ...
      (at pass6 G)
      (at pass7 C)
      (< (distancia-recorrida pass5) 30)
  ))

  (:metric minimize (- (+ (distancia-recorrida pass1) (+ (distancia-recorrida pass2) 
    (+ (* 0.3 (total-time)) (* 0.7 (charges-cost))))) (beneficio-empresa)))
)
